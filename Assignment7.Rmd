...
# The second threshold of 0.8 has a higher kappa value than the first threshold of 0.6. It indicateds that the model with 0.8 threshold will have a better accuracy of predication.
```
