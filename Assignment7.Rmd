...
D1$threshold.pred1 <- ifelse(D1$pred >= 0.7, "yes", "no")

D1$threshold.pred2 <- ifelse(D1$pred >= 0.85, "yes", "no")

D1$threshold.pred3 <- ifelse(D1$pred >= 0.15, "yes", "no") 
...
#The result does not alter a lot though the two thresholds are pretty different
```
