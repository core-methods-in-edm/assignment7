...
library(rpart)
rp <- rpart(level.up ~ post.test.score + forum.posts + pre.test.score + av.assignment.score + messages, method = "class", data = D1)
rp <- rpart(level.up ~ post.test.score + av.assignment.score, method = "class", data = D1)
