...
#What conclusions can you draw about your two thresholds? Threshold one used a small number (.14), whereas threshold two used a large number (.948).  Accuracy slightly decreased from threshold 1 to 2, but precision decreased by .21.  While recall experienced a slight gain.  I am unsure of what I can draw from Kappa, as it is greater than 1. I can say that Kappa slightly increased as a result of increasing the threshold, but that's about it.  To my understanding a Kappa grater than one is not the result you are looking for.  In general(kappa) the higher the better, but I am unsure how that plays in this context.  Maybe there is some kind of package I can use to get better results?  
