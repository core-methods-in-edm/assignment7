...
#Upload data
```{r}
#read the data file and named d1
...
#get the data we have and library the package
...
#the detail 1 model is better, since model approach 1
```
## Part III
#Thresholds
```{r}
...
D1$threshold.pred1 <- ifelse(D1$pred >= 0.6, "yes", "no")
...
D1$threshold.pred2 <- ifelse(D1$pred >= 0.8, "yes", "no")
